...
static float point_1[2] = {1920 * 0.05, 1080 * 0.37};
static float point_2[2] = {1920 * 0.73, 1080 * 0.37};
static float point_3[2] = {1920 * 0.73, 1080 * 0.95};
static float point_4[2] = {1920 * 0.05, 1080 * 0.95};
...
int main(int argc, char** argv)
{
	...
	cv::Mat orig_img;
	cv::Mat img;
	cv::VideoCapture cap("../../video_1920_1080.mp4");
	//cap.set(cv::CAP_PROP_FRAME_WIDTH, 1920);
	//cap.set(cv::CAP_PROP_FRAME_HEIGHT, 1080);
	
	cv::VideoWriter video_writer("result.mp4", cv::VideoWriter::fourcc('H', '2', '6', '4'), 60, cv::Size(1920, 1080));
